        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    ...
                    <a href="addedituserinfo.jsp"><button class="btn btn-default pull-right">Ajouter</button></a>
                </div>
                ...
                <div class="content table-responsive table-full-width">
                    <table id="mytable" class="table table-striped table-bordered table-sm" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="addedituserinfo.jsp?infoId=<%= u.getId() %>"><button class="btn btn-info btn-fill center-pill">Modifier</button></a>
                            </td>
                        </tr>
                        <%
                            }
